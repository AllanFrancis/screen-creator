    ...
    <div className="flex min-h-screen flex-col bg-hero-dark">
      ...
      >
        ...
        <div className="my-4 flex items-center gap-3">
          ...
          <span className="text-xs text-primary-foreground/60">ou</span>
          <div className="h-px flex-1 bg-primary-foreground/20" />
        </div>

        <button
          onClick={signInWithGoogle}
          className="flex w-full items-center justify-center gap-3 rounded-xl bg-card py-4 font-display font-semibold text-foreground shadow-card transition-transform active:scale-[0.98]"
        >
